    ...
    <div className="relative z-10 w-full max-w-md p-8 md:p-10 bg-neutral-950/80 border border-neutral-800/50 backdrop-blur-xl rounded-3xl shadow-2xl shadow-black/80">
      ...
      <div className="space-y-4">
          <button
            ...
            disabled={!!loading}
            className="w-full relative group flex items-center justify-center gap-3 px-6 py-4 bg-neutral-900 hover:bg-neutral-800 text-white rounded-2xl border border-neutral-800 hover:border-neutral-700 transition-all duration-300 overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading === 'github' ? (
            ...
            <span className="font-medium tracking-wide relative z-10">
              {loading === 'github' ? 'Authenticating...' : 'Authenticate via GitHub'}
            </span>
          </button>
          ...
          >
            ...
            <span className="font-medium tracking-wide relative z-10">
              {loading === 'google' ? 'Authenticating...' : 'Authenticate via Google'}
            </span>
          </button>
        </div>
