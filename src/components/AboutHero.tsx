...
const AboutHero = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden" style={{ backgroundColor: 'var(--color-bg-main)' }}>
      <div className="container mx-auto px-4 md:px-8 lg:px-16 pt-32 pb-20">
        <div className="relative flex flex-col items-center">
          ...
          <div className="w-full flex flex-col md:flex-row items-center justify-between mt-8 md:mt-12 gap-8 px-4 md:px-12">
            ...
            <p 
              ...
              style={{ color: isLightMode ? 'rgba(0,0,0,0.6)' : 'rgba(255,255,255,0.6)' }}
            >
