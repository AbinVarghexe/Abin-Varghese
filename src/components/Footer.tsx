...
export default function Footer() {
  ...
  return (
    <footer className="bg-white text-black pt-20 px-6 md:px-12 lg:px-20 overflow-hidden">
          ...
          <div className="flex flex-col h-full">
            {navLinks.map((link, idx) => (
              <Link 
                key={idx} 
                href={link.href}
                className="group flex items-center justify-between p-6 border-b border-black/20 hover:bg-black/5 transition-colors"
              >
      ...
      <div className="mt-20 -mb-4 md:-mb-8 lg:-mb-12">
        <h1 className="text-[12vw] font-bold tracking-tighter leading-none whitespace-nowrap overflow-hidden select-none font-vina uppercase text-black">
          Abin Varghese
        </h1>
      </div>
    </footer>
